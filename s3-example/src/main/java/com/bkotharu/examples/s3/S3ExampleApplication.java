...
public class S3ExampleApplication {
	...
	private ApiInfo generateApiInfo() {
		return new ApiInfo("AWS Examples", "This service is to demonstrate examples of AWS.", "Version 1.0", " ",
				"bhargava.kotharu@gmail.com", "Apache 2.0", "http://www.apache.org/licenses/LICENSE-2.0");
	}
